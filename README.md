# New2Fit - Personalized AI Fitness App For Beginners
...
that can track, analyze, and give real-time feedback for exercises such as bicep curls or lateral raises. The camera will track exercise form through the range of motion, speed, and angle of each repetition. The front end is built with Streamlit. Project deployed with streamlit cloud.
